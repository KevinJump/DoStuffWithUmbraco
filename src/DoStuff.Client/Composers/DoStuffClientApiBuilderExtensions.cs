...
internal static class DoStuffClientApiBuilderExtensions
{
    public static IUmbracoBuilder AddDoStuffClientApi(this IUmbracoBuilder builder)
    {
        ...
        builder.Services.Configure<SwaggerGenOptions>(opt =>
        {
            ...
            {
                Title = "Do Stuff Client Backoffice API",
                Version = "1.0",
...
internal class DoStuffClientOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
{
...
internal class CustomOperationHandler : OperationIdHandler
{
    ...
    {
        return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("DoStuff.Client.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
    }
